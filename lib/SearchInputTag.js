    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchInputTag.__proto__ || Object.getPrototypeOf(SearchInputTag)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return list.map(function (v, index) {
        return _react2.default.createElement(
          'li',
          {
            className: 'sit-li ' + _this.props.liClassName + ' ' + (_this.state.cursor === index ? 'active' : ''),
            key: index,
            value: v.id,
      ...
      if (!_this.props.value) return _this.props.itemList.map(function (v) {
        return _extends({}, v, { labelEl: v.value });
      });
  ...
  _createClass(SearchInputTag, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          restProps = _objectWithoutProperties(_props, ['value', 'InputElement', 'wrapperClassName', 'className', 'ulClassName', 'notExist', 'placeholder']);
